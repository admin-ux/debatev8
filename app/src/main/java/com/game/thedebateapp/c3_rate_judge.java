...
//Description       : This class is the third screen of the judge stream
//Inner Workings    :
...
public class c3_rate_judge extends AppCompatActivity {
    ...
    TextView Arga3, Respb3, TopicHeader3, TopicTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Arga3.setText(gameBeingJudged.getStages().getStage3().getArg());

        Respb3 = (TextView) findViewById(R.id.b3responsepoint);
        Respb3.setText(gameBeingJudged.getStages().getStage3().getResp());
...
//
                submitB.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        gameBeingJudged.getStages().getStage3().setJudgeScoreA(JudgeA);
                        gameBeingJudged.getStages().getStage3().setJudgeScoreR(JudgeR);
                        myArgTimer.cancel();
                        myArgTimer.purge();
                        openReturn_repeat_judge();
    ...
    public void openReturn_repeat_judge(){
