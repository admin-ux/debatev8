...
//                .requestServerAuthCode(getString(R.string.default_web_client_id))
                .requestEmail()
                .build();
        GoogleSignInOptions gso1 = GoogleSignInOptions.DEFAULT_GAMES_SIGN_IN;
//        GoogleSignInOptions gso = new GoogleSignInOptions
//                .Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
...
//                .build();
        ...
        mGoogleSignInClient1 = GoogleSignIn.getClient(this, gso1);
...
//        });
        ...
        btnSignOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(google_signin2.this,"You are Logged Out",Toast.LENGTH_SHORT).show();
...
//                GoogleSignInOptions.DEFAULT_SIGN_IN);
        ...
        Intent signInIntent1 = mGoogleSignInClient1.getSignInIntent();
...
//            }
            ...
            Toast.makeText(google_signin2.this,"Sign In Failed",Toast.LENGTH_SHORT).show();
    ...
    private void FirebaseGoogleAuth(GoogleSignInAccount acct) {
        ...
        if (acct != null) {
            ...
            mAuth.signInWithCredential(authCredential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(google_signin2.this, "Successful", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(google_signin2.this, "acc failed", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void updateUI(FirebaseUser fUser){
        ...
        if(account !=  null){
            ...
            Toast.makeText(google_signin2.this,personName + personEmail ,Toast.LENGTH_SHORT).show();
        }
